        ...
        <tbody>
          {rows.map((row, i) => (
            <tr key={i} className="border-b border-neutral-200 align-top">
              <td className="py-6 pr-3 sm:pr-6 font-serif italic text-base sm:text-lg whitespace-normal sm:whitespace-nowrap text-neutral-900">
                {row.range}
              </td>
              <td className="py-6 pr-3 sm:pr-6 text-neutral-800 leading-relaxed max-w-md">
                {row.requirement}
              </td>
